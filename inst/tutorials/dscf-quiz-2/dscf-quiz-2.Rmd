...
tibble(Competency=c("RMardown",
           ...
           Measure=c(".Rmd renders without errors.",
                   "You effectively and professionally tell the story. Clean document of unnecessary clutter not relevant to the story.",
                   "Correct results"),
           Score=c("1 points",
                   "3 points",
                   "6 points")) %>% bd_lo()
...
This is meant to provide you with insights and as such we use different time periods for display purposes i.e. the numbers will not match the actual solution.
...
```
The following are normally distributed: your answer...
