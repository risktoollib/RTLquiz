...
observe({
  ...
  output$table <- renderRHandsontable({rhandsontable(g1df$data)})
  })
...
#day0a <- g1df$data %>% dplyr::mutate(Answer = 0)
output$table2 <- rhandsontable::renderRHandsontable({rhandsontable::rhandsontable(g1df$data,rowHeaders = NULL)})
```
