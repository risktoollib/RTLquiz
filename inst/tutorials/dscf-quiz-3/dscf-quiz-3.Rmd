...
> This is meant to provide you with PARTIAL insights and as such we use different time periods for display purposes i.e. the numbers will not match the actual solution. Neither is it a representation of the final output.    

**Your final output should answer the questions instead of replicating the hints.**
